...
"use strict";jQuery(document).ready(function(a){var e=a("#toplevel_page_gcmi .wp-menu-name");a.ajax({data:{action:"gcmi_show_data_need_update_notice",_ajax_nonce:gcmi_menu_admin.nonce},dataType:"json",error:function(a){console.log(a)},success:function(a){var n;n=e,0!==(a=a).data.num&&n.append(' <span class="update-plugins '+a.data.num+'"><span class="plugin-count">'+a.data.formatted+"</span></span>")},type:"post",url:gcmi_menu_admin.ajax_url})});