...
create_dist() {
  ...
  cp -Rp admin css img includes integrations languages modules public campi-moduli-italiani.php settings.php composer.json composer.lock index.php license.txt readme.txt readme-it.txt $OUTPUT_PATH
