...
final class GCMI_Comune_Filter_BuilderTest extends WP_Ajax_UnitTestCase {
		...
		return array(
			...
			array(
				array(
					'filtername' => 'fakefilter',
					'includi'    => 'false',
					'codici'     => array( 'C000000', 'C000000', 'C000000' ),
				),
				true,
			),
			array(
		...
		return array(
			array(
				...
				array(
					...
					'includi'    => 'true',
					'codici'     => array( 'C037001', 'C037002', 'C037003', 'C037005', 'C037006', 'C037007', 'C037008', 'C037009', 'C037010', 'C037011', 'C037012', 'C037013', 'C037014', 'C037015', 'C037016', 'C037017', 'C037019' ),
					'total'      => '4',
					'slice'      => '1',
				),
				// success .
			...
			array(
				array(
					'filtername' => 'bo_e_prov_sopp',
					'includi'    => 'true',
					'codici'     => array( 'C037020', 'C037021', 'C037022', 'C037024', 'C037025', 'C037026', 'C037027', 'C037028', 'C037030', 'C037031', 'C037032', 'C037033', 'C037034', 'C037035', 'C037036', 'C037037', 'C037038' ),
					'total'      => '1', // <--.
					'slice'      => '2',
				),
				false,
			...
			array(
				array(
					'filtername' => 'bo_e_prov_sopp',
					'includi'    => true, // <--.
					'codici'     => array( 'C037039', 'C037040', 'C037041', 'C037042', 'C037044', 'C037045', 'C037046', 'C037047', 'C037048', 'C037050', 'C037051', 'C037052', 'C037053', 'C037054', 'C037055', 'C037056', 'C037057' ),
					'total'      => '4',
					'slice'      => '3',
				),
				false,
			...
			array(
				array(
					'filtername' => 'bo_e_prov_sopp',
					'includi'    => 'true',
					'codici'     => array( 'C037059', 'C037060', 'C037061', 'C037062', 'C037004', 'C037018', 'C037023', 'C037029', 'C037043', 'C037049', 'C037058', 'C037801', 'C037802' ),
					'total'      => '4',
					'slice'      => '4',
				),
				true,
	...
	function provideFilterNames() {
		return array(
			array( 'tito_e_dintorni', true ),
			array( '_tito_e_dintorni', false ),
			array( 'tito__e__dintorni', false ),
			array( 'Roma', true ),
			array( true, true ),
			array( 100, true ),
			array( '<code>', true ),
	...
	function test_ajax_get_filters_html(): void {
		...
		$this->assertSame(
			$outputpage,
			trim( $doc->saveHTML() ),
			'Errore nella generazione del codice html dei filtri'
		);
	}
	...
	function test_ajax_get_tabs_html( $input ): void {
		...
		$response        = json_decode( $this->_last_response );
		$html_properties = array( 'regioni_html', 'province_html', 'comuni_html', 'commit_buttons' );
			...
			array(
				array(
					array(
						'filtername' => 'tito_e_dintorni',
						'includi'    => 'true',
						'codici'     => array( array( 'C076001', 'C076013' ) ),
